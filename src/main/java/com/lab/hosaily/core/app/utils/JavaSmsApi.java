...
public class JavaSmsApi {
    ...
    public static void main(String[] args) throws IOException,
        ...
        /**************** 查账户信息调用示例 *****************/
//        System.out.println("JavaSmsApi.getUserInfo(apikey): " + JavaSmsApi.getUserInfo(apikey));
...
//        感谢您注册#app#，您的验证码是#code#
        ...
        String tpl_value = URLEncoder.encode("#code#", ENCODING) + "=" +
                ...
                "#app#", ENCODING) + "=" + URLEncoder.encode("永恒情书",
                ENCODING);

        //模板发送的调用示例
        System.out.println("tpl_value: " + tpl_value);
        System.out.println("JavaSmsApi.tplSendSms(apikey, tpl_id, tpl_value,mobile):" + JavaSmsApi.tplSendSms(apikey, tpl_id, tpl_value, mobile));
