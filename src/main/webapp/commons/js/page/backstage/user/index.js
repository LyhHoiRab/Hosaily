app.controller('userController', function($scope, $http){
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [{
            ...
            displayName: '操作',
            cellTemplate: '<div class="ngCellText" ng-class="col.colIndex()"><span ng-cell-text><a ui-sref="accountCourse({accountId:\'{{row.getProperty(\'accountId\')}}\'})">[课程]</a><a href="javascript:;" ng-click="delete(row.getProperty(\'id\'))">[订单]</a></span></div>'
        }]
    };
