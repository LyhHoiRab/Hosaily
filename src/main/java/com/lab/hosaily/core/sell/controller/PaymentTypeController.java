...
@Controller
@RequestMapping(value = "/page/backstage/paymentType")
public class PaymentTypeController{
    ...
    public ModelAndView index(ModelMap content){
        try{
            return new ModelAndView("backstage/paymentType/index", content);
        }catch(Exception e){
    ...
    public ModelAndView add(ModelMap content){
        try{
            return new ModelAndView("backstage/paymentType/edit", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
