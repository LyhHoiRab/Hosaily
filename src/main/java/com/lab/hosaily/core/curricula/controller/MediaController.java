...
import com.lab.hosaily.core.curricula.consts.SuffixType;
...
public class MediaController{
    ...
    public ModelAndView index(ModelMap content){
        try{
            List<com.lab.hosaily.core.curricula.consts.MediaType> types = Arrays.asList(com.lab.hosaily.core.curricula.consts.MediaType.values());
