package com.lab.hosaily.core.app.controller;
...
@Controller
@RequestMapping(value = "/page/backstage/profile")
public class ProfileController {
    ...
    public ModelAndView index(ModelMap content){
        try{
            return new ModelAndView("backstage/profile/index", content);
        }catch(Exception e){
    ...
    public ModelAndView add(ModelMap content){
        try{
            return new ModelAndView("backstage/profile/edit", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
    ...
    public ModelAndView list(@PathVariable("organizationId") String organizationId, ModelMap content){
        try{
            ...
            return new ModelAndView("backstage/profile/list", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
