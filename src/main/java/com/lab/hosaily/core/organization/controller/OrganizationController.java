package com.lab.hosaily.core.organization.controller;
...
@Controller
@RequestMapping(value = "/page/backstage/organization")
public class OrganizationController{
    ...
    public ModelAndView index(ModelMap content){
        try{
            return new ModelAndView("backstage/organization/index", content);
        }catch(Exception e){
    ...
    public ModelAndView add(ModelMap content){
        try{
            return new ModelAndView("backstage/organization/edit", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
