...
@Controller
@RequestMapping(value = "/page/backstage/record")
public class RecordController {
    ...
    public ModelAndView index(ModelMap content){
        try{
            return new ModelAndView("backstage/record/index", content);
        }catch(Exception e){
    ...
    public ModelAndView add(ModelMap content){
        try{
            return new ModelAndView("backstage/record/edit", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
    ...
    public ModelAndView list(@PathVariable("organizationId") String organizationId, ModelMap content){
        try{
            ...
            return new ModelAndView("backstage/record/list", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
