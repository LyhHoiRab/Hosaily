...
@Controller
@RequestMapping(value = "/page/backstage/option")
public class OptionController {
    ...
    public ModelAndView index(ModelMap content){
        try{
            return new ModelAndView("backstage/option/index", content);
        }catch(Exception e){
    ...
    public ModelAndView add(ModelMap content){
        try{
            return new ModelAndView("backstage/option/edit", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
    ...
    public ModelAndView list(@PathVariable("organizationId") String organizationId, ModelMap content){
        try{
            ...
            return new ModelAndView("backstage/option/list", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
