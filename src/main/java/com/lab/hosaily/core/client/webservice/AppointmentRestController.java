...
public class AppointmentRestController{
    ...
    public Response<Page<Appointment>> page(Long pageNum, Long pageSize, String organizationId, String name, String wechat, String phone, Sex sex, String type){
        try{
            PageRequest pageRequest = new PageRequest(pageNum, pageSize);
            Page<Appointment> page = appointmentService.page(pageRequest, organizationId, name, wechat, phone, sex, type);
