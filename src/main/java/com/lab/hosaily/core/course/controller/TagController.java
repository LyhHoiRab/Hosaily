...
@Controller
@RequestMapping(value = "/page/backstage/tag")
public class TagController{
    ...
    public ModelAndView index(ModelMap content){
        try{
            return new ModelAndView("backstage/tag/index", content);
        }catch(Exception e){
    ...
    public ModelAndView list(@PathVariable("organizationId") String organizationId, ModelMap content){
        try{
            ...
            return new ModelAndView("backstage/tag/list", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
    ...
    public ModelAndView add(ModelMap content){
        try{
            return new ModelAndView("backstage/tag/edit", content);
        }catch(Exception e){
            logger.error(e.getMessage(), e);
            throw new ApplicationException(e.getMessage(), e);
        }
